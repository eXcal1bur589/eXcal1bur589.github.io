...
![Default Apache Page](images/defaultapache.png)
...
![Zone Transfer](images/zonetransfer.png)
...
![Smaller ACC File](images/smalleraccfile.png)
...
![Failed Encryption](images/failedencryption.png)
...
![Support Page Comments](images/supportpagecomments.png)
...
![Meterpreter Setup](images/meterpretersetup.png)
...
![Checking For netcat](images/checkingfornetcat.png)

Now I will use netcat to connect back to my meterpreter listener and get an upgraded shell on the target:

![Connecting With netcat](images/connectingwithnetcat.png)

![Meterpreter Connected](images/meterpreterconnected.png)
...
![Chris Password Reuse](images/chrispasswordreuse.png)
...
![Downloading linpeas](images/downloadinglinpeas.png)
...
![Running SUID 1](images/runningsuid1.png)

![Running SUID 2](images/runningsuid2.png)
...
![passwd File Write 1](images/passwdfilewrite1.png)

![passwd File Write 2](images/passwdfilewrite2.png)
